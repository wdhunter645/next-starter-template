...
Does Not Own: Current ChatGPT startup behavior, full DIATAXIS taxonomy, builder implementation details, or repository workflow implementation
Canonical Reference: /docs/ops/ai/CHATGPT-RULES.md
Archived From: /docs/reference/orchestration/startup-governance.md
Archived Reason: Superseded by Agent.md startup routing and ChatGPT startup contract
