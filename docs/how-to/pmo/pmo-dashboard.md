...
This operator guidance was reconciled directly by ChatGPT / ChatGPT under #2699 from the PMO meeting decisions. It must not be delegated to an implementation agent to reinterpret the meeting record.
