# Visitor Header Design Specification

## Overview
The visitor header implements a locked design pattern with sticky navigation controls and a non-sticky, overlapping logo.
...
- **Components**: Navigation buttons (Join, Search, Store, Login) and hamburger menu
