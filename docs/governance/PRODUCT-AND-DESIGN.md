...
| **PMO / Engineering** | ChatGPT / ChatGPT | Final design package authorship; launch-control packaging; design documentation completeness; primary PR review for product/design changes |
...
| **PR Approver / Engineering** | ChatGPT / ChatGPT (Bill alternate) | Approval and merge of product/design PRs per delivery profile; not a substitute for Product Authority on material product decisions |
