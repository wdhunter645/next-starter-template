...
ChatGPT / Atlas is the normal Engineering preparation owner. Cursor may collaborate for bounded repository inspection, feasibility evidence, validation design, or authorized Sandbox work. Collaboration does not authorize Active implementation.
...
When the PMO meeting sets a Pipeline parent to Engineering P1, the same meeting closeout must create or reactivate one peer Engineering preparation Issue owned by ChatGPT / Atlas.
