...
| A-010 | CI redesign orphan closeout batch support | H-003 shows open superseded redesign issues (`#1011`, `#1009`, `#1199`) obscure true CI state even after merge evidence exists. | S | 2 | CI maintenance / Automation and agent orchestration | ChatGPT/program-owner closeout action only; this report recommends no automated closure without explicit owner direction. |
