...
| 005 | Fan Club dynamic content and media integration | Wire Club Home dynamic sections to approved content/media sources with fail-closed behavior and source/credit display. | Fan Club + backend + content | `src/app/fanclub/**`, scoped `src/components/**`, scoped `src/lib/**`, read-path `functions/api/**` if required, `tests/**`, `docs/ops/reports/**` | Targeted tests; manual route checklist | 004 | 006 |
