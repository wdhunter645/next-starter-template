...
| R-011 | Label/status model mismatch | PMO | medium | medium | Proposed labels conflict with PMO V4 or repo inventory | Label addendum marks PROPOSED vs verified; defer to PMO V4 | ChatGPT | open | **Stop** if PMO decision required (#2364 stop rule) |
