...
PMO v2 defined a five-program lane model (Programs 1–5) with Program 5 as ideas/project-draft intake. PMO v3 replaces that model with issue-number-based program issues and a documentation-owned PMO Backlog.
