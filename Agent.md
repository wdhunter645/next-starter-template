...
Tracker files are historical/status indexes. Agents read or update tracker files only when the source Issue explicitly includes tracker governance in scope.
...
- Tracker/status-index updates: `.agents/skills/lgfc-docs-authority/SKILL.md` only when the source Issue explicitly authorizes tracker governance
