...
export const FINDING_TYPES = Object.freeze({
	...
	STALE_TERMINAL_SOURCE_ISSUE_LABELS: 'stale_terminal_source_issue_labels',
...
const FINDING_TYPE_TO_CATEGORY = Object.freeze({
	...
	[FINDING_TYPES.STALE_TERMINAL_SOURCE_ISSUE_LABELS]: SAFETY_CATEGORIES.SAFE_AUTO_FIX,
...
const LEGACY_CODE_TO_FINDING_TYPE = Object.freeze({
	...
	stale_terminal_source_issue_labels: FINDING_TYPES.STALE_TERMINAL_SOURCE_ISSUE_LABELS,
	missing_terminal_complete_label: FINDING_TYPES.STALE_TERMINAL_SOURCE_ISSUE_LABELS,
	...
	stale_closeout_evidence_merge_sha: FINDING_TYPES.CONTRADICTORY_REPO_STATE,
	missing_closeout_evidence_merge_sha: FINDING_TYPES.CONTRADICTORY_REPO_STATE,
	merge_sha_belongs_to_other_pr: FINDING_TYPES.CONTRADICTORY_REPO_STATE,
	missing_merge_commit_sha: FINDING_TYPES.CONTRADICTORY_REPO_STATE,
