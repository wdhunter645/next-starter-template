...
export const FINDING_TYPES = Object.freeze({
	...
	PENDING_CLOSEOUT_REPLAY: 'pending_closeout_replay',
});
...
const FINDING_TYPE_TO_CATEGORY = Object.freeze({
	...
	[FINDING_TYPES.PENDING_CLOSEOUT_REPLAY]: SAFETY_CATEGORIES.CURSOR_REMEDIATION_REQUIRED,
...
const LEGACY_CODE_TO_FINDING_TYPE = Object.freeze({
	...
	pending_closeout_replay: FINDING_TYPES.PENDING_CLOSEOUT_REPLAY,
});
