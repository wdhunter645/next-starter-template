...
export const RECOVERY_ASSETS = Object.freeze([
  {
    ...
    isolatedTestPlan: 'Completed via #2896 immutable candidate reconstruction at component tip; disposable worktree optional',
    testedStatus: 'tested',
  ...
  },
  {
    ...
    isolatedTestPlan: 'Completed via #2896 candidate reconstruction of representative workflow path; no live deploy',
    testedStatus: 'tested',
    zeroCostBaseline: true,
  },
  {
    ...
    isolatedTestPlan: 'Completed via #2896 offline reconstruction of wrangler.toml at candidate SHA; live dashboard deferred',
  ...
  },
  {
    ...
    isolatedTestPlan: 'Completed via #2896 candidate reconstruction of health handler; no Production deploy',
    testedStatus: 'tested',
    zeroCostBaseline: true,
  },
  {
  ...
  },
  {
    ...
    isolatedTestPlan: 'Completed via #2896 tabletop rollback decision path + candidate SHA selection; live Pages rollback deferred',
    testedStatus: 'partial',
    zeroCostBaseline: true,
  },
  {
