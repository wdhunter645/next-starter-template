...
export const RECOVERY_ASSETS = Object.freeze([
  ...
  },
  {
    ...
    backupMethod: 'Provider durability + planned `wrangler d1 export` / authorized export scripts (prove in #2895)',
    ...
    rpo: '24 hours (target until measured)',
    rto: '8 hours (target until measured)',
    credentialBoundary: 'CLOUDFLARE_API_TOKEN + account/database ids; export artifacts must be redacted/access-controlled',
    isolatedTestPlan: 'Export to disposable file; restore into isolated non-Production D1; schema + app check; delete test DB (#2895)',
    testedStatus: 'untested_restore',
    zeroCostBaseline: true,
  },
  {
  ...
  },
  {
    ...
    backupMethod: 'Provider object durability + version/lifecycle assumptions (prove in #2896 path / #2895 B2 proof)',
    ...
    rto: '24 hours (target until measured)',
    credentialBoundary: 'B2_KEY_ID / B2_APP_KEY / endpoint / bucket names only',
    isolatedTestPlan: 'List/sample integrity on disposable prefix or read-only sample; no Production deletes (#2895/#2896)',
    testedStatus: 'untested_restore',
    zeroCostBaseline: true,
  },
  {
    ...
    isolatedTestPlan: 'Dry-run sync against isolated D1 + read-only B2 list when credentials authorized',
    testedStatus: 'untested_restore',
    zeroCostBaseline: true,
  },
  {
