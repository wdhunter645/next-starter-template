...
const loginLink = '<Link className={styles.btn} href="/join">Login</Link>';
const idxLogin = header.indexOf(loginLink);
...
must(idxLogin !== -1, 'Header missing Login link to /join');
