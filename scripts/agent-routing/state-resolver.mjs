...
export function resolveRepositoryState(input = {}, policy = {}) {
  ...
  const snapshotData = {
    ...
    // Pre-normalized by evidence-adapters/issue-pr-contract.mjs (#2621).
    // The resolver passes it through rather than re-deriving contract
    // semantics, matching how checks/reviews/pullRequests are consumed.
    issuePrContract: input.issuePrContract || null,
  };
  return {
    ...snapshotData,
