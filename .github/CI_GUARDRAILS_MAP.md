...
| `ai-execution-bridge-smoke.yml` | AI Execution Bridge Smoke Test | Effective | Weekly (Mon 09:00 UTC) and on bridge path changes on `main`: unit tests plus synthetic issue validation/plan smoke; closes passing smoke issues. |
