...
describe('post-merge closeout all manifests', () => {
	...
	it('loads rerun targets for PR #1765 (#1754), PR #1764 (#1755), PR #1536 (#1258), PR #1639 (#1638), and PR #1747 (#1736)', () => {
		const { targets } = loadCloseoutTargets('scripts/ci/post-merge-closeout/targets-ci-pending-rerun.json');
		expect(targets.map((target) => target.pr)).toEqual([1765, 1764, 1536, 1639, 1747]);
		...
		expect(targets[1]).toMatchObject({
			body_file: 'scripts/ci/post-merge-closeout/pr-1764-body.md',
			merge_sha: 'dbb23abafda4b12b483de34443729e833ca56582',
			source_issue: 1755,
		});
